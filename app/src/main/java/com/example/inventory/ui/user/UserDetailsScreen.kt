...
fun UserDetailsScreen(
    ...
    viewModel: UserDetailsViewModel = viewModel(factory = AppViewModelProvider.Factory) // 🔹 Inicializando o ViewModel
    ...
    Scaffold(
        ...
        UserDetailsBody(
            ...
            onSellUser = { },
            onDelete = { viewModel.deleteUser(navigateBack)},
            modifier = Modifier
                .padding(
   ...
   userDetailsUiState: UserDetailsUiState,
    ...
    Column(
        ...
        UserDetails(
            ...
            user = userDetailsUiState.userDetails.toUser(),
...
fun UserDetailsScreenPreview() {
    InventoryTheme {
        UserDetailsBody(
            UserDetailsUiState(
                outOfStock = true,
                userDetails = com.example.inventory.ui.user.UserDetails(1, "John", "john@aol", "30")
            ),
            onSellUser = {},
            onDelete = {}
        )
